import { CustomError, IAuthPayload, IErrorResponse, winstonLogger } from '@greatdaveo/jobint-shared';
...
export function startAuthServer(app: Application): void {
...
// To send JSON data and use req.body
